  ...
  return (
    <div className="container mx-auto p-4 sm:p-6 lg:p-8 my-4 sm:my-6 lg:my-8 md:flex">
      ...
      <div className="w-full md:w-1/3 flex flex-col justify-start p-4 sm:p-6 lg:p-8 gap-2 sm:gap-3">
        <h1 className="text-xl sm:text-3xl font-extrabold text-[#B07FD3]">
          From The Blogs
        </h1>
        <p className="text-lg sm:text-2xl font-bold text-[#999999]">
          Explore the world of print with us on our blog!
        </p>
        <p className="text-sm sm:text-xl font-bold text-[#5D5D5D] text-pretty">
      ...
      <div className="flex flex-col md:flex-row gap-4 sm:gap-6 lg:gap-8">
        <a
          ...
          className=""
        >
          <div className="banner_1 w-full md:w-[350px] h-auto cursor-pointer overflow-hidden shadow-lg rounded-md">
            <img
              src={blog1}
              alt="Blog post 1"
